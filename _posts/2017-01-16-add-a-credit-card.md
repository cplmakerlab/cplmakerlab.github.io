...
Jekyll is a simple, blog-aware, static site generator. It takes a template directory containing raw text files in various formats, runs it through a converter (like Markdown) and our Liquid renderer, and spits out a complete, ready-to-publish static website suitable for serving with your favorite web server. Like a **regular** thing.
...
## How to install[\#](#how-to-install){: .header-link}
...
## Next steps[\#](#next-steps){: .header-link}

Building a Jekyll site with the default theme is just the first step. The real magic happens when you start creating blog posts, using the front matter to control templates and layouts, and taking advantage of all the awesome configuration options Jekyll makes available.

## Basic usage[\#](#basic-usage){: .header-link}
...
## Directory structure[\#](#directory-structure){: .header-link}
...
## Front matter[\#](#front-matter){: .header-link}
...
## Where additional pages live[\#](#where-additional-pages-live){: .header-link}
